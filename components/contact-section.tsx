...
export function ContactSection() {
  ...
  return (
    <section id="contacto" className="relative bg-background overflow-hidden">
      ...
      <div className="relative w-full h-[40vh] lg:h-[45vh] overflow-hidden bg-secondary/50">
        ...
        >
          <span className="inline-block text-xs font-bold uppercase tracking-[0.3em] text-primary mb-4 bg-card/80 backdrop-blur-sm px-4 py-1.5 rounded-full">
            Contacto
          </span>
          <h2 className="text-5xl font-bold text-foreground sm:text-6xl lg:text-7xl text-balance leading-tight">
            <span className="bg-card/70 backdrop-blur-sm px-4 py-1 rounded-2xl inline-block">
              Hablemos de tu{" "}
              <span className="font-serif italic text-primary">proyecto.</span>
            </span>
          </h2>
        </div>
      </div>
      ...
      <div className="relative -mt-20 mx-auto max-w-4xl px-6 pb-24 lg:pb-32">
        ...
        >
          <div className="rounded-[2rem] border border-border bg-card p-8 lg:p-12 shadow-2xl">
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-20 text-center animate-scale-in">
                ...
                <h4 className="text-3xl font-bold text-foreground font-serif">¡Mensaje recibido!</h4>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-8">
                ...
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className={`rounded-2xl border-2 bg-background px-5 py-4 text-sm text-foreground placeholder:text-muted-foreground transition-all duration-300 outline-none ${
                        focusedField === "name"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className={`rounded-2xl border-2 bg-background px-5 py-4 text-sm text-foreground placeholder:text-muted-foreground transition-all duration-300 outline-none resize-none ${
                      focusedField === "message"
                        ? "border-[#D4A853] shadow-lg shadow-[#D4A853]/10"
                        : "border-border hover:border-[#D4A853]/30"
                    }`}
