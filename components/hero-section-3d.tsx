    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 pb-8 sm:pb-16 lg:pb-24">
        <div className="max-w-2xl">
          ...
          {/* CTAs */}
          <div
            className={`mt-6 sm:mt-8 flex flex-col gap-2 sm:gap-4 sm:flex-row transition-all duration-1000 delay-700 ${
              isLoaded
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-12"
            }`}
        ...
        <div
          className={`mt-2 sm:mt-12 hidden sm:flex justify-center lg:justify-start transition-all duration-1000 delay-1000 ${
